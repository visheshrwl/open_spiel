...
This process has been written for Windows 11 and tested on Windows 11 Version 25H2,
build 26200.8037 (April 2026).
...
3.  Once the Ubuntu environment is running, follow the standard Linux installation
    instructions in [install.md](install.md) to clone, build, and set up OpenSpiel.
